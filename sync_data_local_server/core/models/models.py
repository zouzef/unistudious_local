...
class SessionModel(BaseModel):
    ...
    columns = [
       ...
       Column("payment_deadline", "VARCHAR(255)", default=None),
...
class FormationModel(BaseModel):
	...
	columns = [
		...
		Column("condition_of_passage", "VARCHAR(255)", nullable=True),
		Column("condition_of_passage_formule", "VARCHAR(255)", nullable=True),
		Column("condition_of_passage_formule_by_note", "VARCHAR(255)", nullable=True),
		Column("condition_of_passage_formule_by_present", "VARCHAR(255)", nullable=True),
		Column("condition_of_passage_formule_by_note_present", "VARCHAR(255)", nullable=True),
		Column("img_link", "VARCHAR(255)"),
		Column("public_resource", "VARCHAR(255)"),
		Column("enabled", "TINYINT(1)", nullable=False, default="1"),
		Column("created_at", "DATETIME", nullable=False, default="current_timestamp()"),
