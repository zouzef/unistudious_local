        ...
        try:
            ...
            if not virtuel_user_rows:
                ...
                self._process_audit_rows(
                    ...
                    virtuel_user_rows,
                    {
                        "CREATE": lambda row: push_virtuelAdd(db, self.settings, row),
                        "UPDATE": lambda row: push_virtuelUpdate(db, self.settings, row),
                        "DELETE": lambda row: push_virtuelDelete(db, self.settings, row),
