...
def _send_calendar_special_group(settings, payload):
	...
	try:
		...
		if response.status_code == 200:
			...
			print(f"✅ Got calendarId={calendar_remote_id}, newGroupSpecialId={group_remote_id}, relationTeacherSubject={relation_Teacher_Subject}")
			...
			return False, None, None,None  # ✅ Handle other status codes
