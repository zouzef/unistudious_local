...
def _send_calendar_special_group(settings, payload):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            group_remote_id = response_data.get('newGroupSpecialId')  # ✅ Fixed key

            print(f"✅ Got calendarId={calendar_remote_id}, newGroupSpecialId={group_remote_id}")
            return True, calendar_remote_id, group_remote_id  # ✅ Added return
            ...
            return False, None, None  # ✅ Handle other status codes

    except requests.exceptions.Timeout:
        print(f"❌ Request timeout (10s)")
        return False, None, None  # ✅ Fixed to 3 values
    except Exception as e:
        print(f"❌ Remote API error: {str(e)}")
        return False, None, None  # ✅ Fixed to 3 values
