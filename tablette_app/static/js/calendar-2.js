  ...
  var calendar = new Calendar(calendarEl, {
      ...
      fetch(`/get-calendar-room/${roomId}`)
        ...
        .then((data) => {
          ...
          if (data.Message === "Successfully got calendar room" && data.Data) {
            ...
            console.error(
              "Failed to fetch events - unexpected response format",
            );
    ...
    eventClick: function (info) {
      ...
      if (desc) {
        ...
        document.getElementById("modal-description-container").style.display =
          "block";
      } else {
        document.getElementById("modal-description-container").style.display =
          "none";
      ...
      document.getElementById("modal-header-banner").style.background =
        "#4D44B5";
